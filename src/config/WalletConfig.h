...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "disc";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "STCH";
    ...
    const std::string daemonName = "Spitchd";

    /* The name to call this wallet */
    const std::string walletName = "Spitch-Wallet";

    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "Spitch-service";
