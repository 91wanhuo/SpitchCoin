...
namespace CryptoNote {
    namespace parameters {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x3445db;                       
        ...
        const uint64_t MONEY_SUPPLY                                  = UINT64_C(200'000'000'00000000);   
        ...
        You can get this value by doing "print_block 2" in Spitchd. It is used to know what timestamp
        to import from when the block height cannot be found in the node or the node is offline. */
        const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1590329379;
    ...
    const char     CRYPTONOTE_NAME[]                             = "Spitch";
    ...
    const int      P2P_DEFAULT_PORT                              =  20200;
    const int      RPC_DEFAULT_PORT                              =  20201;
    const int      SERVICE_DEFAULT_PORT                          =  20202;
    ...
    const char     LATEST_VERSION_URL[]                          = "https://github.com/SpitchCoin/SpitchCoin/releases";
    const std::string LICENSE_URL                                = "https://github.com/SpitchCoin/SpitchCoin/blob/master/LICENSE";
    const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
    {
        {  0x50, 0x12, 0x1c, 0x10, 0x20, 0x2c, 0x2d, 0x0c, 0x30, 0x12, 0x34, 0x56, 0x78, 0x80, 0x0a, 0x1b  }
    };
