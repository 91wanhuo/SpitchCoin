...
function usage()
{
    ...
    echo "and generates the checksum files of the Spitch tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/Spitch/Spitch.git"
CLONE_DIR="$BUILD_DIRECTORY/Spitch-buildall"
TARGET_DIR="$BUILD_DIRECTORY/Spitch-releases"
DYNAMIC_RELEASE="Spitch-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="Spitch-${TAG_VERSION}-linux-staticboost-CLI"
